...
$toemails[] = array(
				'email' => 'info@kryfton.com', // Your Email Address
				'name' => 'Kryfton Solutions' // Your Name
			);
...
$fromemail = array(
				'email' => 'info@kryfton.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Kryfton Solutions' // Company Name
			);
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong></strong>. All Rights Reserved.';

	$mail->Subject = !empty( $submits['subject'] ) ? $submits['subject'] : 'New Application From Careers Page - From Website';
